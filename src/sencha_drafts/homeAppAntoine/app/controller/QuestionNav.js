        ...
        if (record.get('leaf')===true){
         ...
         questionsNavView.pop();
            questionsNavView.push({
                    ...
                    {
                      xtype:'panel',
                      html: '<div style="-webkit-overflow-scrolling:touch; overflow:auto;width=100%;height=100%;position:fixed;top:0;left:0;float:left;z-index:99;""><iframe style=position:fixed;top:0;left:0;float:left;z-index:1;" width="100%" height="100%" src=\"http://192.168.56.101/mediawiki-1.21.2/index.php/'+record.get('wiki')+'\"</iframe></div>'
                    }
                        ]});
